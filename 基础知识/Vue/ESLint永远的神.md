...
> 之前写的文章，现在感觉真是天真，写代码还是尽量加eslint语法检查，保持代码风格，因为维护别人风骚的代码是很累的。
...
```
eslint src # 检测代码格式是否有不符合规则
eslint --fix src # 按照配置的eslint规则修复代码格式
```
...
// eslint-disable-line no-alert, quotes, semi // 单行禁用指定规则检查
// eslint-disable-next-line // 禁用下一行eslint检查
// eslint-disable-next-line no-alert, quotes, semialert('foo') // 下一行禁用指定规则检查
```

[ESlint官网](https://eslint.org/)
[ESlint中文网](https://eslint.bootcss.com/)

可以在官网里查对应规则的详细说明和推荐写法。

作者：mengdu
        链接：https://segmentfault.com/a/1190000008742240
        来源：SegmentFault 思否
